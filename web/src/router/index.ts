...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/workbench/:key?', name: 'workbench', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '配置工作台', issue: 4 } },
  { path: '/routes', name: 'routes', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '反代路由', issue: 2 } },
  ...
  { path: '/deploys', name: 'deploys', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '下发记录', issue: 5 } },
  { path: '/audit', name: 'audit', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '审计日志', issue: 10 } },
